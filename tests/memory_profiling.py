...
"""
Memory Profiling für IBU Turniere v1.1.0-alpha.4

Testet Memory Leaks und Speichernutzung mit tracemalloc.
"""
...
from app.core import get_resource_manager, cleanup_all_resources
...
class MemoryProfiler:
    """Memory Profiler für Leak Detection."""
...
def test_resource_manager_memory():
    """Testet Memory Usage des Resource Managers."""
    print("Testing Resource Manager Memory Usage...")
    ...
    try:
        ...
        # Snapshot vor Resource Manager Tests
        profiler.take_snapshot("Before resource manager tests")
        
        # Erstelle Timer und Widgets
        timers = []
        widgets = []
        ...
        # Snapshot nach Erstellung
        profiler.take_snapshot("After creating resources")
        
        # Resource Manager Statistiken
        resource_manager = get_resource_manager()
        stats = resource_manager.get_stats()
        print(f"Resource Manager Stats: {stats}")
        
        # Cleanup
        cleanup_all_resources()
        
        # Snapshot nach Cleanup
        profiler.take_snapshot("After cleanup")
        
        # Vergleiche Snapshots
        print("\nMemory comparison: Before vs After creating resources")
        profiler.compare_snapshots(0, 1)
        
        print("\nMemory comparison: After creating vs After cleanup")
        profiler.compare_snapshots(1, 2)
        
        # Finale Statistiken
        final_stats = resource_manager.get_stats()
        print(f"Final Resource Manager Stats: {final_stats}")
...
def test_performance_benchmark():
    ...
    try:
        ...
        # Erstelle 100 Turniere und Teilnehmer
        for i in range(100):
...
def main():
    ...
    print("=" * 60)
    print("IBU Turniere v1.1.0-alpha.4 - Memory Profiling Tests")
    print("=" * 60)
    print()
