...
def _normalize_otp_email(value: object) -> object:
    """Strip whitespace and trailing dots (paste/autofill) before EmailStr validation."""
...
class VerifyOTPRequest(BaseModel):
    ...
    @classmethod
    def _strip_otp(cls, v: object) -> object:
        if isinstance(v, str):
            return v.strip()
        return v
