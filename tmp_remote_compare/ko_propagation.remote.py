...
def save_ko_result_and_propagate(
    ...
    # Default behavior keeps manual/random_each_round untouched.
    # For admin simulation we can force full automatic propagation across all rounds.
    if tournament and tournament.ko_draw_method is not None:
        ...
        if draw_method_val == 'manual' and not force_propagate:
            return
    ...
    if draw_mode == "random_each_round" and not force_propagate:
