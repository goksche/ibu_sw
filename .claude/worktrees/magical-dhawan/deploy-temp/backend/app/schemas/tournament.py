...
from app.models.tournament import TournamentMode, TournamentStatus, KOStructure, KODrawMethod, LeagueScoringSystem, LeagueVariant
...
class TournamentUpdate(BaseModel):
    ...
    ko_participants: int | None = Field(default=None, ge=0)
    ko_first_round_size: int | None = Field(default=None, ge=4, le=16)
